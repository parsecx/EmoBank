...
public partial class Login : System.Web.UI.Page
{
    ...
    private bool Login1()
    {
        ...
        int result = IsValidUser(userName, out hPassword, out sPassword, out UserId, out UserType, out ExpiryDate);
        if (result > 0)
        {
    ...
    private int IsValidUser(string userName, out string hPassword, out string sPassword, out string UserId, out string UserType,out string ExpiryDate)
    {
        ...
        if (tb.Rows.Count > 0)
        {
            ...
            ExpiryDate = tb.Rows[0]["PSWDeadline"].ToString();
