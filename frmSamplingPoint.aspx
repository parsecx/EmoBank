<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="frmSamplingPoint.aspx.cs" Inherits="frmSamplingPoint" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="page animsition">
        <div class="page-header">
            <h1 class="page-title">Ambulatori Punti Prelievo</h1>
        </div>
                            ...
                            <div class="row row-lg">
                                <div class="col-sm-12">
                                    ...
                                    <div class="example-wrap">
                                        ...
                                        <div class="example">
                                            <asp:GridView ID="grdData" ShowHeaderWhenEmpty="true" DataKeyNames="CodID"
                                                AutoGenerateColumns="false" runat="server" data-mobile-responsive="true"
                                                border="1" Style="width: 100%" OnSorting="grdData_Sorting"
                                                PageSize="50" AllowSorting="true" AllowPaging="true"
                                                OnPageIndexChanging="grdData_PageIndexChanging"
                                                OnRowCommand="grdData_RowDataCommand" OnRowDataBound="grdData_RowDataBound"
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ValidationGroup="A"
                                                runat="server" SetFocusOnError="true" ErrorMessage="Enter Email Id" ControlToValidate="txtE_mail" ForeColor="Red">*</asp:RequiredFieldValidator>
                                                    ...
                                                    <asp:TextBox type="text" runat="server" class="form-control" ID="txtE_mail" name="inputEmail"
                                                        placeholder="E_mail" autocomplete="off" MaxLength="40"></asp:TextBox>
                                                </div>
                                            </div>
