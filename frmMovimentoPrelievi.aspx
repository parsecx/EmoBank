                                        ...
                                        <div class="example">
                                            ...
                                            <asp:GridView ID="grdData" ShowHeaderWhenEmpty="false" DataKeyNames="CodID" AutoGenerateColumns="false" runat="server" data-mobile-responsive="true" border="1" Style="width: 100%" OnSorting="grdData_Sorting" PageSize="500" AllowSorting="true" AllowPaging="false" OnPageIndexChanging="grdData_PageIndexChanging" OnRowCommand="grdData_RowCommand" OnRowDataBound="grdData_RowDataBound" OnSelectedIndexChanged="grdData_SelectedIndexChanged" ShowHeader="false" CssClass="Head-table1">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="DateTimeDrawing" HeaderText="Data Prelievo " SortExpression="DateTimeDrawing" DataFormatString = "{0:dd/MM/yyyy}" ItemStyle-Width="10%" />
                                           ...
                                           <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator16" ValidationGroup="A" runat="server"
                                            ...
                                            <div id="pnlAnimalList" runat="server">
                                                <div class="row" style="margin-bottom: 30px; padding: 10px; border: 2px solid rgb(249, 104, 104);">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-sm-12">
                                                            <h4 style="background: none repeat scroll 0% 0% rgb(249, 104, 104); color: white; margin: -10px; padding: 10px;">Riferimenti Animale
                                                           <a id="MODIFICA23" runat="server" class="btn btn-primary floatleft"  onServerclick="grdAnimals_MODIFICA" >MODIFICA</a>
                                                            </h4>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <%--<div class="row">
                                                        <div class="form-group col-sm-12">
                                                            <h4 style="background: none repeat scroll 0% 0% rgb(249, 104, 104); color: white; margin: -10px; padding: 10px;">Riferimenti Animale</h                                                          
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-sm-2">

                                                     <a id="A1" runat="server" class="btn btn-primary floatleft" data-toggle="modal" data-target="#myModal">MODIFICA</a>
                                                         </div>    --%>        
                                                    <div class="row">
