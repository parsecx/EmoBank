<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="frmAnagraficaDonatori.aspx.cs"  Inherits="frmAnagraficaDonatori" %>
                        ...
                        <div class="panel-body container-fluid">
                            <div class="row row-lg">
                                <div class="col-sm-12">
                                    <!-- Example Basic Form -->
                                    <div class="example-wrap">
                                        <h4>Scheda Anagrafica Donatore</h4>
                                        <div class="example">
                                        ...
                                        <div class="example">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-sm-3">
                                                    <asp:Button ID="btnUpdate" Text="Registra" ValidationGroup="A" CssClass="btn btn-primary floatRight" runat="server" OnClick="btnUpdate_Click" />
                                                </div>
                                                        ...
                                                        <div class="form-group col-sm-12">
                                                            <asp:GridView ID="grdAnimals" runat="server" ShowHeaderWhenEmpty="true" DataKeyNames="Progressive" AutoGenerateColumns="false" data-mobile-responsive="true" border="1" Style="width: 100%" OnRowCommand="grdAnimals_RowCommand" OnRowDataBound="grdAnimals_RowDataBound" OnSelectedIndexChanged="grdAnimals_SelectedIndexChanged">
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="AnimalName" HeaderText="Nome" />
                                                                    <asp:BoundField DataField="AnimalWeight" HeaderText="Peso" ItemStyle-CssClass="textright"/>
                                                                    <asp:BoundField DataField="AgeAnimal" HeaderText="Eta" ItemStyle-CssClass="textright"/>
                                                                    ...
                                                                    <asp:BoundField DataField="AttachmentCount" HeaderText="Numero Allegati" ItemStyle-CssClass="textright" />
                                                                </Columns>
                                                                <EmptyDataTemplate>
                                                                    No Record Found
                                                                </EmptyDataTemplate>
                                                ...
                                                <div class="row" style="margin-bottom: 30px; padding: 10px; border: 2px solid rgb(249, 104, 104);">
                                                    ...
                                                    <div class="form-group col-sm-3">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator17" ValidationGroup="D" runat="server"
                                                          ...
                                                          <asp:RegularExpressionValidator ID="reg1" runat="server" ValidationExpression="^[0-9]+([,][0-9]{1,2})?$" ControlToValidate="txtPeso" ValidationGroup="D" Display="Dynamic" SetFocusOnError="true" ForeColor="Red" ErrorMessage="Enter Peso Lordo Decimal Value">*</asp:RegularExpressionValidator>
                                                    ...
                                                    <div class="form-group col-sm-3">
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ValidationExpression="^[0-9]?[0-9]?(\,[0-9][0-9]?)?" ControlToValidate="txtAge" ValidationGroup="D" Display="Dynamic" SetFocusOnError="true" ForeColor="Red" ErrorMessage="Enter valid Età (Anni,Mesi)">*</asp:RegularExpressionValidator>
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="example-wrap">
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-sm-12">
                                                                        <label class="control-label" for="inputBasicFirstName">Descrizione Allegato </label>
                                                                             ...
                                                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator20" ValidationGroup="F" runat="server"
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-sm-12">
                                                                        <label class="control-label" for="inputBasicFirstName">Data Inserimento</label>
                                                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator19" ValidationGroup="F" runat="server"
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-sm-12">
                                                                        ...
                                                                        <label class="control-label" for="inputBasicFirstName">Allega file</label>
                                                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator21" ValidationGroup="F" runat="server"
                                                            ErrorMessage="Allega file" SetFocusOnError="true" ControlToValidate="upFile" ForeColor="Red">*</asp:RequiredFieldValidator>
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-sm-12">
                                                                        <asp:Button ID="btnSubmit" runat="server" ValidationGroup="F" Text="Submit" CssClass="btn btn-primary floatRight" OnClick="btnSubmit_Click" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
