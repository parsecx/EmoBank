<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="frmAnalisiPrelievi.aspx.cs" Inherits="frmAnalisiPrelievi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="page animsition">
        <div class="page-header">
            <h1 class="page-title">Analisi Prelievi</h1>
        </div>
        ...
        <div class="page-content">
            ...
            <asp:UpdatePanel ID="up1" runat="server" UpdateMode="Conditional">
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="btnRicerca" EventName="Click" />
                            ...
                            <div class="row row-lg">
                                <div class="col-sm-12">
                                    ...
                                    <div class="example-wrap">
                                        <div class="row">
                                            <div class="form-group col-sm-8" style="padding-left: 293px">
                                                ...
                                                <p style="font-size: 16px; padding: 6px;">
                                                    ...
                                                    <asp:DropDownList runat="server" ID="ddlSeleziona" OnSelectedIndexChanged="ddlSeleziona_SelectedIndexChanged"
                                                        AutoPostBack="true">
                                                        <asp:ListItem Text="Nuovi Per FrigoEmoteca" Value="Nuovi Per FrigoEmoteca" Selected="True"></asp:ListItem>
                                                        <asp:ListItem Text="Presenti In FrigoEmoteca" Value="Presenti In FrigoEmoteca"></asp:ListItem>
                                                        <asp:ListItem Text="Consegnati Cliniche" Value="Consegnati Cliniche"></asp:ListItem>
                                                    </asp:DropDownList>
                                                </p>
                                            </div>
                                            ...
                                            <div class="form-group col-sm-2">
                                                <%-- <asp:LinkButton ID="lnkFilter" runat="server" Text="Ricerca Avanzata" OnClientClick="return false;"
                                                    CssClass="btn btn-primary" data-toggle="modal" data-target="#myModal"></asp:LinkButton>--%>
                                                <a id="lnkFilter" onclick="return false;" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Ricerca Avanzata</a>
                                            </div>
                                        ...
                                        <div class="example" style="overflow-x: scroll">
                                            <%--<table data-mobile-responsive="true" border="1" style="width: 1603px; margin-bottom: 10px" class="Head-table">
                                                <tr>--%>
                                            ...
                                            <%-- <th style="width: 7%; padding: 0px;">
                                                    ...
                                                    <th style="width: 7%; padding: 0px;">
                                                        <asp:LinkButton ID="lnkDateLoadBloodBankRefrigerator" runat="server" Text="Data Car. Frigo" OnClick="lnk_Click" CommandArgument="DateLoadBloodBankRefrigerator"></asp:LinkButton>
                                                    </th>
                                                     <th  style="width: 7%; padding: 0px;">
                                                         <asp:LinkButton ID="lnkFrigoEmoteca" runat="server" Text="Frigo Emoteca" OnClick="lnk_Click" CommandArgument="FrigoEmoteca"></asp:LinkButton></th>
                                                    </th>
                                                    <th style="width: 7%; padding: 0px;">
                                                        <asp:LinkButton ID="lnkDatedrainBloodBankRefrigerator" runat="server" Text="Data Sca. Frigo" OnClick="lnk_Click" CommandArgument="DateLoadBloodBankRefrigerator"></asp:LinkButton>
                                                    </th>
                                                    <th style="width: 16%; padding: 0px;">
                                                    ...
                                                    <th style="width: 7%; padding: 0px;">
                                                        <asp:LinkButton ID="lnkDateReceiptClinic" runat="server" Text="Data Consegna" OnClick="lnk_Click" CommandArgument="DateReceiptClinic"></asp:LinkButton></th>
                                                </tr>
                                                <tr>--%>
                                            <%--<th style="width: 11%; padding: 0px;">
                                            ...
                                            <%--  <th style="width: 7%; padding: 0px;">
                                                    ...
                                                    <th style="width: 3%; padding: 0px;"></th>
                                                    ...
                                                    <th style="width: 7%; padding: 0px;">
                                                        <asp:DropDownList ID="ddldatacarFrigo" runat="server" class="form-control" OnSelectedIndexChanged="ddlCod_SelectedIndexChanged" AutoPostBack="true">
                                                        </asp:DropDownList></th>
                                                    <th style="width: 7%; padding: 0px;">
                                                        <asp:DropDownList ID="ddlFrigoEmo" runat="server" class="form-control" OnSelectedIndexChanged="ddlCod_SelectedIndexChanged" AutoPostBack="true">
                                                        </asp:DropDownList></th>
                                                    <th style="width: 7%; padding: 0px;">
                                                    ...
                                                    <th style="width: 16%; padding: 0px;">
                                                        <asp:DropDownList ID="ddlClinicaVetern" runat="server" class="form-control" OnSelectedIndexChanged="ddlCod_SelectedIndexChanged" AutoPostBack="true">
                                                        </asp:DropDownList></th>
                                                    <th style="width: 7%; padding: 0px;">
                                                        <asp:DropDownList ID="ddlDataConsegna" runat="server" class="form-control" OnSelectedIndexChanged="ddlCod_SelectedIndexChanged" AutoPostBack="true">
                                                        </asp:DropDownList></th>
                                                </tr>
                                            </table>--%>
                                            <asp:GridView ID="grdData" ShowHeaderWhenEmpty="false" DataKeyNames="CodID" AutoGenerateColumns="false" runat="server" data-mobile-responsive="true" border="1" Style="width: 1803px" OnSorting="grdData_Sorting" PageSize="500" AllowSorting="true" AllowPaging="false" ShowHeader="true" OnPageIndexChanging="grdData_PageIndexChanging" OnRowCommand="grdData_RowCommand" OnRowDataBound="grdData_RowDataBound" OnSelectedIndexChanged="grdData_SelectedIndexChanged" AlternatingRowStyle-BackColor="#A1DCF2" CssClass="Head-table1">
                                                <Columns>
                                                    ...
                                                    <%-- <asp:BoundField DataField="CodID" SortExpression="CodID" HeaderText="Cod. Interno" ItemStyle-CssClass="itemstyle" />--%>
                                                    <%--<asp:BoundField DataField="ProtocolNumber" SortExpression="ProtocolNumber" HeaderText="Protocollo" ItemStyle-Width="7%" ItemStyle-CssClass="textright" />
                                                    <asp:BoundField DataField="Progressive" SortExpression="Progressive" HeaderText="Pr." ItemStyle-Width="3%" ItemStyle-CssClass="textright" />
                                                    <asp:BoundField DataField="DateTimeDrawing" SortExpression="DateTimeDrawing" HeaderText="Data Prelievo" ItemStyle-Width="7%" />
                                                    <asp:BoundField DataField="Description" SortExpression="Description" HeaderText="Punto Prelievo" ItemStyle-Width="16%" />
                                                    <asp:BoundField DataField="SpeciesName" SortExpression="SpeciesName" HeaderText="Aninale" ItemStyle-Width="7%" />
                                                    <asp:BoundField DataField="AnimalGroupBlood" SortExpression="AnimalGroupBlood" HeaderText="Grouppo Sanguigno" ItemStyle-Width="7%" />
                                                    <asp:BoundField DataField="Name" SortExpression="Name" HeaderText="Donatore" ItemStyle-Width="15%" />
                                                    <asp:BoundField DataField="DateLoadBloodBankRefrigerator" SortExpression="DateLoadBloodBankRefrigerator" HeaderText="Data Car. FRigo" ItemStyle-Width="7%" />
                                                    <asp:BoundField DataField="FrigoEmoteca" SortExpression="FrigoEmoteca" HeaderText="Frigo Emoteca" ItemStyle-Width="7%" />
                                                    <asp:BoundField DataField="DatedrainBloodBankRefrigerator" SortExpression="DatedrainBloodBankRefrigerator" HeaderText="Data Sca. FRigo" ItemStyle-Width="7%" />
                                                    <asp:BoundField DataField="ClinicName" SortExpression="ClinicName" HeaderText="Clinica Veterinaria" ItemStyle-Width="16%" />
                                                    <asp:BoundField DataField="DateReceiptClinic" SortExpression="DateReceiptClinic" HeaderText="Data Consegna" ItemStyle-Width="7%" />--%>


                                                    <asp:TemplateField SortExpression="ProtocolNumber" HeaderText="Protocol Number">
                                                        <HeaderTemplate>
                                                            <asp:LinkButton ID="lnkProtocolNumber" runat="server" Text="Protocollo" OnClick="lnk_Click" CommandArgument="ProtocolNumber"></asp:LinkButton>
                                                            <asp:DropDownList ID="ddlProtocol1" runat="server" class="form-control" OnSelectedIndexChanged="ddlCod_SelectedIndexChanged" AutoPostBack="true" EnableViewState="true" CssClass="dropdownstyle">
                                                            </asp:DropDownList>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:Literal ID="ltlProtocolNumber" runat="server" Text='<%# Bind("ProtocolNumber") %>'></asp:Literal>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField SortExpression="Progressive" HeaderText="Pr.">
                                                        <HeaderTemplate>
                                                            Pr.
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:Literal ID="ltlProgressive" runat="server" Text='<%# Bind("Progressive") %>'></asp:Literal>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField SortExpression="DateTimeDrawing" HeaderText="Data Preliev">
                                                        <HeaderTemplate>
                                                            <asp:LinkButton ID="lnkDateTimeDrawing" runat="server" Text="Data Prelievo" OnClick="lnk_Click" CommandArgument="DateTimeDrawing"></asp:LinkButton>
                                                            <asp:DropDownList ID="ddlDateTimeDrawing1" runat="server" class="form-control" OnSelectedIndexChanged="ddlCod_SelectedIndexChanged" AutoPostBack="true" CssClass="dropdownstyle">
                                                            </asp:DropDownList>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:Literal ID="ltlDateTimeDrawing" runat="server" Text='<%# Bind("DateTimeDrawing") %>'></asp:Literal>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField SortExpression="Description" HeaderText="Punto Prelievo">
                                                        <HeaderTemplate>
                                                            <asp:LinkButton ID="lnkDescription" runat="server" Text="Punto Prelievo" OnClick="lnk_Click" CommandArgument="Description"></asp:LinkButton>
                                                            <asp:DropDownList ID="ddlDescription1" runat="server" class="form-control" OnSelectedIndexChanged="ddlCod_SelectedIndexChanged" AutoPostBack="true" CssClass="dropdownstyle">
                                                            </asp:DropDownList>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField SortExpression="SpeciesName" HeaderText="Aninale">
                                                        <HeaderTemplate>
                                                            <asp:LinkButton ID="lnkAninale" runat="server" Text="Aninale" OnClick="lnk_Click" CommandArgument="SpeciesName"></asp:LinkButton>
                                                            <asp:DropDownList ID="ddlSpeciesName1" runat="server" class="form-control" OnSelectedIndexChanged="ddlCod_SelectedIndexChanged" AutoPostBack="true" CssClass="dropdownstyle">
                                                            </asp:DropDownList>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:Literal ID="ltlSpeciesName" runat="server" Text='<%# Bind("SpeciesName") %>'></asp:Literal>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField SortExpression="AnimalGroupBlood" HeaderText="Gruppo Sanguigno">
                                                        <HeaderTemplate>
                                                            <asp:LinkButton ID="lnkAnimalGroupBlood" runat="server" Text="Gruppo Sanguigno" OnClick="lnk_Click" CommandArgument="AnimalGroupBlood"></asp:LinkButton>
                                                            <asp:DropDownList ID="ddlAnimalGroupBlood1" runat="server" class="form-control" OnSelectedIndexChanged="ddlCod_SelectedIndexChanged" AutoPostBack="true" CssClass="dropdownstyle">
                                                            </asp:DropDownList>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:Literal ID="ltlAnimalGroupBlood" runat="server" Text='<%# Bind("AnimalGroupBlood") %>'></asp:Literal>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField SortExpression="Name" HeaderText="Donatore">
                                                        <HeaderTemplate>
                                                            <asp:LinkButton ID="lnkName" runat="server" Text="Donatore" OnClick="lnk_Click" CommandArgument="Name"></asp:LinkButton>
                                                            <asp:DropDownList ID="ddlNamee1" runat="server" class="form-control" OnSelectedIndexChanged="ddlCod_SelectedIndexChanged" AutoPostBack="true" CssClass="dropdownstyle">
                                                            </asp:DropDownList>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:Literal ID="ltlName" runat="server" Text='<%# Bind("Name") %>'></asp:Literal>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField SortExpression="DateLoadBloodBankRefrigerator" HeaderText="Data Car. FRigo">
                                                        <HeaderTemplate>
                                                            <asp:LinkButton ID="lnkDateLoadBloodBankRefrigerator" runat="server" Text="Data Car. FRigo" OnClick="lnk_Click" CommandArgument="DateLoadBloodBankRefrigerator"></asp:LinkButton>
                                                            <asp:DropDownList ID="ddldatacarFrigo" runat="server" class="form-control" OnSelectedIndexChanged="ddlCod_SelectedIndexChanged" AutoPostBack="true" CssClass="dropdownstyle">
                                                            </asp:DropDownList>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:Literal ID="ltlDateLoadBloodBankRefrigerator" runat="server" Text='<%# Bind("DateLoadBloodBankRefrigerator") %>'></asp:Literal>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField SortExpression="FrigoEmoteca" HeaderText="Frigo Emoteca">
                                                        <HeaderTemplate>
                                                            <asp:LinkButton ID="lnkFrigoEmoteca" runat="server" Text="Frigo Emoteca" OnClick="lnk_Click" CommandArgument="FrigoEmoteca"></asp:LinkButton>
                                                            <asp:DropDownList ID="ddlFrigoEmo" runat="server" class="form-control" OnSelectedIndexChanged="ddlCod_SelectedIndexChanged" AutoPostBack="true" CssClass="dropdownstyle">
                                                            </asp:DropDownList>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:Literal ID="ltlFrigoEmoteca" runat="server" Text='<%# Bind("FrigoEmoteca") %>'></asp:Literal>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField SortExpression="DatedrainBloodBankRefrigerator" HeaderText="Data Sca. FRigo">
                                                        <HeaderTemplate>
                                                            <asp:LinkButton ID="lnkDatedrainBloodBankRefrigerator" runat="server" Text="Data Sca. FRigo" OnClick="lnk_Click" CommandArgument="DateLoadBloodBankRefrigerator"></asp:LinkButton>
                                                            <asp:DropDownList ID="ddlDataScaFrigo" runat="server" class="form-control" OnSelectedIndexChanged="ddlCod_SelectedIndexChanged" AutoPostBack="true" CssClass="dropdownstyle">
                                                            </asp:DropDownList>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:Literal ID="ltlDatedrainBloodBankRefrigerator" runat="server" Text='<%# Bind("DatedrainBloodBankRefrigerator") %>'></asp:Literal>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField SortExpression="ClinicName" HeaderText="Clinica Veterinaria">
                                                        <HeaderTemplate>
                                                            <asp:LinkButton ID="lnkClinicName" runat="server" Text="Clinica Veterinaria" OnClick="lnk_Click" CommandArgument="ClinicName"></asp:LinkButton>
                                                            <asp:DropDownList ID="ddlClinicaVetern" runat="server" class="form-control" OnSelectedIndexChanged="ddlCod_SelectedIndexChanged" AutoPostBack="true" CssClass="dropdownstyle">
                                                            </asp:DropDownList>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:Literal ID="ltlClinicName" runat="server" Text='<%# Bind("ClinicName") %>'></asp:Literal>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField SortExpression="DateReceiptClinic" HeaderText="Data Consegna">
                                                        <HeaderTemplate>
                                                            <asp:LinkButton ID="lnkDateReceiptClinic" runat="server" Text="Data Consegna" OnClick="lnk_Click" CommandArgument="DateReceiptClinic"></asp:LinkButton>
                                                            <asp:DropDownList ID="ddlDataConsegna" runat="server" class="form-control" OnSelectedIndexChanged="ddlCod_SelectedIndexChanged" AutoPostBack="true" CssClass="dropdownstyle">
                                                            </asp:DropDownList>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:Literal ID="ltlDateReceiptClinic" runat="server" Text='<%# Bind("DateReceiptClinic") %>'></asp:Literal>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                                <EmptyDataTemplate>
                                    ...
                                    <div class="example-wrap">
                                        ...
                                        <div class="example">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-sm-2">
                                                    <asp:Button ID="btnRegister" Text="Registra" ValidationGroup="A" CssClass="btn btn-primary floatRight" runat="server" OnClick="btnRegister_Click" Visible="false" />
                                           ...
                                           <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator16" ValidationGroup="A" runat="server"
                                            ...
                                            <div id="pnlCaricoFrigo" runat="server">
                                            ...
                                            <div id="pnlClinicalVeterinaria" runat="server">
                                                <div class="row" style="margin-bottom: 30px; padding: 10px; border: 2px solid #fc0;">
                                                    <div class="row">
                                                        <div class="form-group col-sm-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-sm-12">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator29" ValidationGroup="A" runat="server"
                                                                ErrorMessage="Enter Indirzzo" SetFocusOnError="true" ControlToValidate="txtclincaIndirrzo" ForeColor="Red">*</asp:RequiredFieldValidator>
                                                            <asp:TextBox type="text" runat="server" class="form-control" MaxLength="40" ID="txtclincaIndirrzo"
                                                                placeholder="Indirzzo" autocomplete="off" ReadOnly="true"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator33" ValidationGroup="A"
                                                runat="server" SetFocusOnError="true" ErrorMessage="Enter Data Richiesta" ControlToValidate="txtclincaDataRichiesta" ForeColor="Red">*</asp:RequiredFieldValidator>
                                                            <asp:TextBox type="text" runat="server" class="form-control myDate" ID="txtclincaDataRichiesta" name="inputEmail"
                                                                placeholder="Data Richiesta" autocomplete="off" disabled="disabled"></asp:TextBox>
                                                        </div>
                                                        <div class="form-group col-sm-3">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator34" ValidationGroup="A"
                                                runat="server" SetFocusOnError="true" ErrorMessage="Enter Data Scarico Frigo" ControlToValidate="txtclincaDataScaricoFrigo" ForeColor="Red">*</asp:RequiredFieldValidator>
                                                            <asp:TextBox type="text" runat="server" class="form-control myDate" ID="txtclincaDataScaricoFrigo" name="inputEmail"
                                                                placeholder="Data Scarico Frigo" autocomplete="off" MaxLength="10" disabled="disabled"></asp:TextBox>
                                                        </div>
                                                        <div class="form-group col-sm-3">
                                                            <label class="control-label" for="inputBasicEmail">Utente</label>
                                                            &nbsp;
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator35" ValidationGroup="A"
                                                runat="server" SetFocusOnError="true" ErrorMessage="Enter Utente" ControlToValidate="txtclincaUtente" ForeColor="Red">*</asp:RequiredFieldValidator>
                                                            <asp:TextBox type="text" runat="server" class="form-control" ID="txtclincaUtente" name="inputEmail"
                                                                placeholder="Utente" autocomplete="off" MaxLength="20" disabled="disabled"></asp:TextBox>
                                                        </div>
                                                    </div>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator36" ValidationGroup="A"
                                                runat="server" SetFocusOnError="true" ErrorMessage="Enter  Data Consegna" ControlToValidate="txtclincaDataConsegna" ForeColor="Red">*</asp:RequiredFieldValidator>
                                                            <asp:TextBox type="text" runat="server" class="form-control myDate" ID="txtclincaDataConsegna" name="inputEmail"
                                                                placeholder="Data Consegna" disabled="disabled" autocomplete="off" MaxLength="10"></asp:TextBox>
                                                        </div>
                                                        <div class="form-group col-sm-6">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator37" ValidationGroup="A"
                                                runat="server" SetFocusOnError="true" ErrorMessage="Enter Protocolllo" ControlToValidate="txtclincaProtocolllo" ForeColor="Red">*</asp:RequiredFieldValidator>
                                                            <asp:TextBox type="text" runat="server" class="form-control" ID="txtclincaProtocolllo" name="inputProtocolllo"
                                                                placeholder="Protocolllo" disabled="disabled" autocomplete="off" MaxLength="10"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="example">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group col-sm-2" style="text-align: right">
                                                                        <asp:Button ID="btnRicerca" runat="server" Text="Ricerca" CssClass="btn btn-primary" OnClientClick="RicercaClick()" OnClick="btnRicerca_Click" />
                                                                    </div>
                                                                    <div class="form-group col-sm-2">
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-sm-3">
                                                                        <label class="control-label" for="inputBasicFirstName">Data Prelievo Da:</label>

                                                                    </div>
                                                                    <div class="form-group col-sm-4">
                                                                        <asp:TextBox type="text" runat="server" MaxLength="9" class="form-control myDate" ID="txtFromPrelievoDate"
                                                                            autocomplete="off"></asp:TextBox>
                                                                    </div>
                                                                    <div class="form-group col-sm-1" style="text-align: center">
                                                                        <label class="control-label" for="inputBasicFirstName">A</label>
                                                                    </div>
                                                                    <div class="form-group col-sm-4">
                                                                        <asp:TextBox type="text" runat="server" MaxLength="9" class="form-control myDate" ID="txtToPrelievoDate"
                                                                            autocomplete="off"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-sm-3">
                                                                        <label class="control-label" for="inputBasicFirstName">Protocollo Da :</label>

                                                                    </div>
                                                                    <div class="form-group col-sm-4">
                                                                        <asp:TextBox type="text" runat="server" MaxLength="9" class="form-control" ID="txtProtocolFrom"
                                                                            autocomplete="off"></asp:TextBox>
                                                                    </div>
                                                                    <div class="form-group col-sm-1" style="text-align: center">
                                                                        <label class="control-label" for="inputBasicFirstName">A</label>
                                                                    ...
                                                                    <div class="form-group col-sm-4">
                                                                        <asp:TextBox type="text" runat="server" MaxLength="9" class="form-control" ID="txtProtocolTo"
                                                                            autocomplete="off"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-sm-3">
                                                                        <label class="control-label" for="inputBasicFirstName">Ambulatorio Prelievo :</label>

                                                                    </div>
                                                                    <div class="form-group col-sm-9">
                                                                        <asp:DropDownList runat="server" class="form-control" ID="ddlAmbuPrelievo">
                                                                        </asp:DropDownList>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-sm-3">
                                                                        <label class="control-label" for="inputBasicFirstName">Animale :</label>

                                                                    </div>
                                                                    <div class="form-group col-sm-9">
                                                                        <asp:DropDownList runat="server" MaxLength="9" class="form-control" ID="ddlAnimale">
                                                                        </asp:DropDownList>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group col-sm-9">
                                                                        <asp:DropDownList runat="server" MaxLength="9" class="form-control" ID="ddlGruppoSangue">
                                                                        </asp:DropDownList>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-sm-3">
                                                                        <label class="control-label" for="inputBasicFirstName">Donatore :</label>

                                                                    </div>
                                                                    <div class="form-group col-sm-9">
                                                                        <asp:DropDownList runat="server" MaxLength="9" class="form-control" ID="ddlDonator">
                                                                        </asp:DropDownList>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-sm-3">
                                                                        <label class="control-label" for="inputBasicFirstName">Data Carico Frigo   Da :</label>

                                                                    </div>
                                                                    <div class="form-group col-sm-4">
                                                                        <asp:TextBox type="text" runat="server" MaxLength="9" class="form-control myDate" ID="txtDataCaricoFromDate"
                                                                            autocomplete="off"></asp:TextBox>
                                                                    </div>
                                                                    <div class="form-group col-sm-1" style="text-align: center">
                                                                        <label class="control-label" for="inputBasicFirstName">A</label>
                                                                    ...
                                                                    <div class="form-group col-sm-4">
                                                                        <asp:TextBox type="text" runat="server" MaxLength="9" class="form-control myDate" ID="txtDataCaricoToDate"
                                                                            autocomplete="off"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-sm-3">
                                                                        <label class="control-label" for="inputBasicFirstName">Frigo Emoteca :</label>
                                                                    </div>
                                                                    <div class="form-group col-sm-9">
                                                                        <asp:DropDownList runat="server" MaxLength="9" class="form-control" ID="ddlFrigoEmoteca">
                                                                        </asp:DropDownList>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-sm-3">
                                                                        <label class="control-label" for="inputBasicFirstName">Clinica Veterinaria :</label>

                                                                    </div>
                                                                    <div class="form-group col-sm-9">
                                                                        <asp:DropDownList runat="server" MaxLength="9" class="form-control" ID="ddlClinicVeterina">
                                                                        </asp:DropDownList>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group col-sm-4">
                                                                        <asp:TextBox type="text" runat="server" MaxLength="9" class="form-control myDate" ID="txtDataConsegnaFromDate"
                                                                            autocomplete="off"></asp:TextBox>
                                                                    </div>
                                                                    <div class="form-group col-sm-1" style="text-align: center">
                                                                        <label class="control-label" for="inputBasicFirstName">A</label>
                                                                    ...
                                                                    <div class="form-group col-sm-4">
                                                                        <asp:TextBox type="text" runat="server" MaxLength="9" class="form-control myDate" ID="txtDataConsegnaToDate"
                                                                            autocomplete="off"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                            </div>
